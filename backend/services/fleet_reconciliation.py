        ...
        suggestions.append(
            {
                ...
                "brand": str(vehicle.get("brand") or "") or None,
                "model": str(vehicle.get("model") or "") or None,
                "status": str(vehicle.get("status") or "active") or "active",
                ...
                "gps_provider": str(vehicle.get("gps_provider") or "") or None,
                "gps_external_id": str(vehicle.get("gps_external_id") or "") or None,
                "gps_last_seen_at": str(vehicle.get("gps_last_seen_at") or "") or None,
                "has_gps_link": bool(vehicle.get("has_gps_link")),
                "documents_count": int(vehicle.get("documents_count", 0) or 0),
                "has_pending_documents": bool(vehicle.get("has_pending_documents", False)),
