    ...
    >
      ...
      {count !== undefined && (
        <span className={`
          ...
          ${active ? 'bg-white/20' : 'bg-gray-800 text-gray-400'}
        `}>
          {count}
        </span>
      )}
  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="
          w-full pl-9 pr-3 py-2 rounded-lg bg-gray-900 border border-gray-700
  ...
  return (
    <div className="relative">
      <select
        ...
        onChange={(e) => onChange(e.target.value)}
        className="
          w-full px-3 py-2 pr-8 rounded-lg bg-gray-900 border border-gray-700
    ...
    <div className="relative group">
      ...
      {showMenu && (
        <>
          ...
          />
          <div className="absolute top-0 right-0 z-50 mt-1 mr-1 bg-gray-800 rounded-lg shadow-xl border border-gray-700 py-1 min-w-[120px]">
            <button
...
function EmptyState({ filter }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-8 text-center">
      ...
      <p className="text-sm text-gray-500">{messages[filter] || messages.all}</p>
    </div>
  );
}
...
export function RoutesPalette({ 
  ...
  return (
    <div className="w-full bg-gray-800 rounded-xl border border-gray-700/50 flex flex-col h-full overflow-hidden">
